...
_LIVE_STATE_SYSTEM_PROMPT = (
    ...
    "\n"
    "Use 2-3 bullets. The '→' recommendation must fit the state — e.g. lean into "
    "focused work, a slow breath to settle inner noise, or a walk / light "
    "movement to lift a low or flat state. Keep the whole reply under 60 words. "
    "Only rely on the metrics provided.\n"
    "\n"
