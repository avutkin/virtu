...
_LIVE_STATE_SYSTEM_PROMPT = (
    ...
    "\n"
    "BULLETS (2-3) — data-driven and in PLAIN everyday language, each ONE sentence "
    "that connects a real change to what it MEANS and how it feels (like 'Energy "
    "is up and steady — real drive, not stress' or 'The mental static is fading — "
    "your focus is sharpening'). Include a rough PERCENT CHANGE for the main thing "
    ...
    "LF/HF, 'vagal tone', 'inner noise', 'coherence', 'entropy', 'deceleration'. "
