...
_SYSTEM_PROMPT = (
    "You are an expert physiologist reviewing one logged activity's heart-rate-"
...
_LIVE_STATE_SYSTEM_PROMPT = (
    ...
    "the recommendation.\n"
    "\n"
    "State map — pick the closest 2-3 word label (blend two if between, e.g. "
    "'Calm & Clear' or 'Alert & Upbeat'). HRV reflects the autonomic state "
    "directly; treat mood labels (happy, grumpy…) as a gentle inference from "
    "that pattern, not a certainty.\n"
    "Relaxation / calm:\n"
    "• Calm & Present — low/steady HR; high or rising RMSSD, RSA, Vagal Tone, "
    "Calm Power; high coherence; low LF/HF; low inner noise.\n"
    "• Deeply Relaxed — low HR, very high vagal metrics (RMSSD/RSA/Vagal "
    "Tone/Calm Power), high coherence, slow breathing, low LF/HF.\n"
    "• Recovering — HR falling while RSA, RMSSD, Vagal Tone and coherence rise.\n"
    "Focus / mental clarity:\n"
    "• Clear & Focused — DFA alpha-1 near 1.0; low/falling inner noise; steady "
    "HR; good coherence and Adaptive Capacity.\n"
    "• In Flow — sustained very low inner noise + DFA alpha-1 near 1.0 + steady "
    "moderate HR; deeply absorbed.\n"
    "• Foggy & Scattered — high/rising inner noise; DFA alpha-1 drifting toward "
    "0.5; low coherence; hard to concentrate.\n"
    "Alertness / energy:\n"
    "• Alert & Energized — moderately elevated HR with balanced LF/HF; solid "
    "RMSSD; DFA alpha-1 at or just above 1.0; low inner noise — activated, not "
    "stressed.\n"
    "• Low & Fatigued — low HR but blunted RMSSD, Vagal Tone, Calm Power and low "
    "Adaptive Capacity; under-activated and flat.\n"
    "Mood (inferred):\n"
    "• Positive & Upbeat — high coherence with good RMSSD/RSA, balanced LF/HF, "
    "low inner noise, steady HR — markers that tend to accompany a good mood.\n"
    "• Content & Settled — balanced metrics, decent RMSSD, low inner noise, "
    "steady HR; an easy neutral-positive baseline.\n"
    "• Grumpy & Irritable — mildly elevated HR and LF/HF; suppressed RMSSD; "
    "reduced coherence; moderate inner noise — low-grade tension.\n"
    "Stress:\n"
