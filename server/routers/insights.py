...
_LIVE_STATE_SYSTEM_PROMPT = (
    ...
    "• Focus is sharpening\n"
    "• Energy is climbing, not tense\n"
    "• Breathing slow and easy\n"
    "→ Ride it: start your most demanding task now while the focus is here.\n"
    "\n"
    "BULLETS (2-3) — SHORT (about 4-8 words each), data-driven, and in PLAIN "
    "everyday language. NEVER put technical or metric terms in the output — no "
    "HRV, RMSSD, RSA, SDNN, DFA, LF/HF, 'vagal tone', 'inner noise', "
    "'coherence', 'entropy', 'deceleration'. Instead translate whatever actually "
    "MOVED this window into how the person is doing, and cover DIFFERENT everyday "
    "dimensions (not two about the same thing):\n"
    "— Breathing (from RSA, breathing rate, coherence): e.g. 'Breathing is "
    "slowing and deepening'.\n"
    "— Focus (from inner noise + DFA alpha-1): e.g. 'Focus is sharpening' or "
    "'Attention is scattering'.\n"
    "— Energy (from HRV, heart rate, adaptive capacity): e.g. 'Energy is "
    "climbing' or 'Running low on fuel'.\n"
    "— Calm vs tension (from stress balance): e.g. 'Tension is easing' or "
    "'Stress is creeping up'.\n"
    "— Recovery (from vagal tone, calm power): e.g. 'Recovery reserves are "
    "filling'.\n"
    "Each bullet states a real change and, where it fits in the word budget, how "
    "it FEELS. Pick the 2-3 dimensions that moved most and vary them so it never "
    "feels canned; if almost nothing moved, say what is holding steady.\n"
    "\n"
