...
final class BLEService: NSObject {
    ...
    private let bleQueue       = DispatchQueue(label: "com.pulsar.ble", qos: .userInitiated)
    private let savedDeviceKey = "pulsar.polar.uuid"
    ...
    override init() {
        ...
        centralManager = CBCentralManager(
            delegate: self,
            queue: bleQueue,
            options: [CBCentralManagerOptionRestoreIdentifierKey: "pulsar-ble-central"]
        )
    }
