...
| Modify | `Virtu.xcodeproj/project.pbxproj` — file reference rename (`ActivityMetricsCard.swift` → `ActivityMetricsGrid.swift`), add entry for `ActivityWindowChart.swift` |
