...
final class BLEService: NSObject {
    ...
    private let bleQueue       = DispatchQueue(label: "com.virtu.ble", qos: .userInitiated)
    private let savedDeviceKey = "virtu.polar.uuid"
    ...
    override init() {
        ...
        centralManager = CBCentralManager(
            delegate: self,
            queue: bleQueue,
            options: [CBCentralManagerOptionRestoreIdentifierKey: "virtu-ble-central"]
        )
    }
